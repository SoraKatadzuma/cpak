...
const std::error_category& cpak::generic_category() noexcept {
    static CPakGenericErrorCategory category;
    return category;
}


const std::error_category& cpak::build_category() noexcept {
    static CPakBuildErrorCategory category;
    return category;
}


const std::error_category& cpak::unknown_category() noexcept {
